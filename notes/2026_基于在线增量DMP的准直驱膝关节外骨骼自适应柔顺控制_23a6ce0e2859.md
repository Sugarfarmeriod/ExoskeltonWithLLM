...
- 题目：基于在线增量DMP的准直驱膝关节外骨骼自适应柔顺控制
- 作者：未提供
- 年份：2026
- 期刊/会议：仪器仪表学报
- DOI：10.19650/j.cnki.cjsi.J2614961
- URL：https://doi.org/10.19650/j.cnki.cjsi.j2614961
- PDF 状态：manual_pdf

## 2. 一句话结论

可映射到 MO_Kp/MO_Kd；可映射到 AO/Phi/Phase0Event 与 phase_offset；可映射到 DMP Amplitude 和 SafeTorque 约束
...
- 当前自动判断：可映射到 MO_Kp/MO_Kd；可映射到 AO/Phi/Phase0Event 与 phase_offset；可映射到 DMP Amplitude 和 SafeTorque 约束
