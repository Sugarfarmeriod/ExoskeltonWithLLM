...
- 年份：2023
- 期刊/会议：未提供
- DOI：10.36227/techrxiv.22327378
- URL：https://doi.org/10.36227/techrxiv.22327378
- PDF 状态：manual_pdf
...
IMU, 足底压力/力传感, 膝速度, 膝力矩/交互力矩, EMG, 治疗师/语义输入
...
&lt;p&gt;Task-invariant control paradigms can enable lowerlimb exoskeletons to provide assistance
for their users across various locomotor tasks without prescribing to specific joint kinematics. As
an energetic control method, energy shaping can alter a human’s body energetics in the closed-loop
to provide gait benefits. To obtain the energy shaping law for underactuated systems, a set of
...
calculated using an able-bodied subject’s kinematic data well match human biological
torques.&lt;/p&gt;
